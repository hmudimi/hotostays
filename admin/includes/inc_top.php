...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header">
        ...
        <img src="<?php echo DOCBASE.ADMIN_FOLDER; ?>/images/logo-admin.png" width="60" height="50"><a class="navbar-brand" href="<?php echo DOCBASE.ADMIN_FOLDER; ?>/"><?php echo SITE_TITLE; ?><span class="hidden-xs"> </span></a>
        <div class="pull-right hidden-xs" id="info-header">
             <i class="fas fa-fw fa-user"></i> <?php echo "<b>".$_SESSION['user']['login']."</b> (".$_SESSION['user']['type'].")"; ?>&nbsp;
