...
<head>
    ...
    <link rel="stylesheet" href="<?php echo getFromTemplate("css/custom.css"); ?>">
      <link rel="stylesheet" href="<?php echo getFromTemplate("css/a.css"); ?>">
...
<header class="navbar-fixed-top" role="banner">
 ...
 <button class="myButton1" > Login /Sign Up </button>
                            </a>
                            <?php
                        } ?>
                    </li>
                                    ...
                                    <form method="post" action="<?php echo DOCBASE.$page['alias']; ?>" class="ajax-form">
                                        ...
                                        <div class="row mb10">
                                            <div class="col-sm-7 text-left">
                                                ...
                                                <a class="open-signup-form" href="#"><?php echo $texts['SIGN_UP']; ?></a>
                                            </div>
