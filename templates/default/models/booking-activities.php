                        ...
                        <div class="row booking-result activity-result">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-5 sep">
                                <div class="activity-data">
                                    ...
                                    <div class="hb-calendar" data-cur_month="<?php echo gmdate('n', $_SESSION['book']['from_date']); ?>" data-cur_year="<?php echo gmdate('Y', $_SESSION['book']['from_date']); ?>" data-custom_var="activity=<?php echo $id_activity; ?>" data-day_loader="<?php echo DOCBASE.'templates/'.TEMPLATE.'/common/get_days_activity.php'; ?>"></div>
                                </div>
                            </div>
                        </div>
                        <hr>
