...
if(isset($_POST['book']) || (ENABLE_BOOKING_REQUESTS == 1 && isset($_POST['request']))){
    ...
    $_SESSION['book']['children'] = $_POST['children'];
     $_SESSION['book']['rooms'] = $_POST['rooms'];
...
$query_room = 'SELECT * FROM pm_room WHERE id_hotel = :id_hotel AND checked = 1 AND room_type = 1 AND lang = '.LANG_ID;
                    ...
                    if($result_hotel !== false){
                        foreach($result_hotel as $i => $row){
                            ...
                            <form action="<?php echo DOCBASE.$sys_pages['booking']['alias']; ?>" method="post" class="ajax-form">
                                ...
                                <div class="boxed mb20 booking-result" onclick="window.location='<?php echo DOCBASE.$sys_pages['hotels']['alias'].'/'.text_format($hotel_alias); ?>';" style="cursor:pointer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-md-<?php echo (isset($destination) || $nb_destinations > 0) ? 5 : 6; ?>">
                                            <h3>
                                        ...
                                        <div class="col-sm-4 col-md-4 text-center sep" >
                                            ...
                                            <a class="btn btn-primary mt10 btn-block" href="<?php echo DOCBASE.$sys_pages['hotels']['alias'].'/'.text_format($hotel_alias); ?>" style="display:none;">
                                                <i class="fas fa-fw fa-plus-circle"></i>
                                                <?php echo $texts['READMORE']; ?>
                                            </a>
                                            <a href="#" data-target="#btn-collapse-<?php echo $id_hotel; ?>" class="btn btn-success btn-block mt10 anchor-toggle" style="display:none;">
                                                <?php echo $texts['BOOK']; ?>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="display:none;">
                                        <div class="col-md-12">
                                            <span id="btn-collapse-<?php echo $id_hotel; ?>" data-toggle="collapse" data-target="#collapse-<?php echo $id_hotel; ?>" class="btn-toggle<?php if((!isset($_POST['hotel_id']) || $_POST['hotel_id'] != $id_hotel) && $num_results != 1) echo ' collapsed'; ?>">
                                    ...
                                    <div class="row"><!-- 
                                    	-->
                                        <div class="col-md-12 panel-collapse collapse<?php echo ((!isset($_POST['hotel_id']) || $_POST['hotel_id'] != $id_hotel) && $num_results != 1) ? ' collapse' : ' in'; ?>" id="collapse-<?php echo $id_hotel; ?> " style="display: none;">
                                            <div class="boxed">
                                                <?php
                                                $result_room= array(); //->execute();
                    ...
                    <aside class="col-md-3">
                        <div class="boxed mb20">
                                ...
                                <div class="owl-carousel owlWrapper" data-items="1" data-autoplay="false" data-dots="true" data-nav="false" data-rtl="<?php echo (RTL_DIR) ? 'true' : 'false'; ?>">
                                    ...
                                    if($result_destination_file !== false){
                                        ...
                                        foreach($result_destination_file as $i => $row){
                                            ...
                                            if(is_file($realpath)){ ?>
                                                <img alt="<?php echo $label; ?>" src="<?php echo $thumbpath; ?>" class="img-responsive" style="max-height:200px;"/>
                                                <?php
                                            }
                                        }
                                    } ?>
                            ...
                            if($nb_destinations > 0){ ?>
                                ...
                                <h2 class="mt10 mb10"><?php echo $texts['TOP_DESTINATIONS']; ?></h2>
